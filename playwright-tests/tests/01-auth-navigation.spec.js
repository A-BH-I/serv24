import { test, expect, loginAsClient, loginAsProvider, useMocks } from '../fixtures/test-base.js';

test.describe('Authentication, Route Guards & Platform Navigation (JS)', () => {
  ...
  test('TEST-AUTH-07: Platform Banner - Coming Soon mode takeover', async ({ page, mockApi }) => {
    test.skip(!useMocks, 'Mock mode required for simulated banner takeover');
