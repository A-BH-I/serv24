import { test, expect, loginAsProvider } from './fixtures/test-base';

test.describe('Provider Operations & Job Execution', () => {
  ...
  test('TEST-PROV-02: Provider online duty status toggle interaction', async ({ page }) => {
    ...
    if (await toggleBtn.isVisible()) {
      ...
      // Status badge should update or toast notification appear
